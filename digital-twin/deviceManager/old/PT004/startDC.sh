...
"$EDGEPATH" "file:///C:${path}/${FILENAME}?cameraid=${DCWS3}&ip=${DEFAULTSERVERIP}&port=${DEFAULTSERVERPORT}" &
"$FIREFOXPATH" "file:///C:${path}/${FILENAME}?cameraid=${DCWS4}&ip=${DEFAULTSERVERIP}&port=${DEFAULTSERVERPORT}" & sleep 3
