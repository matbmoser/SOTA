      ...
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        ...
        <div class="modal-header d-flex justify-content-between">
          ...
          <div class="mb-3"><label for="cameraServerPort" class="col-form-label">Server PORT:</label>
              ...
              <button type="button" id="open" onclick="connectToServer()" class="btn btn-success">Connect Camera</button>
              <button type="button" id="close" onclick="disconnectFromServer()" class="hidden btn btn-danger">Disconnect Camera</button>
          </div>
        </div>
      </div>
    </div>